...
mycroft provide. It saves "patients" via theire names in a data structur. 
Furthermore can you add heartrates to a patient. 
...
To use all the commands, you have to add a patient first. A proper name exists 
allways of first and last name. The skill will tell you if the naming was not
successfull. If you use the command to delete the data strukture, the skill will 
will ask for your confirmation. You should wait some seconds before you awnser. 
